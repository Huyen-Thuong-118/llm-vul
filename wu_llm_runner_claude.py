"""
Wu et al. — LLM Runner cho Claude Sonnet 5 qua OpenRouter

Config khac Qwen:
  - Model:    anthropic/claude-sonnet-5
  - Env:      OPENROUTER_API_KEY (chung voi Qwen)
  - Khong can tat thinking
  - Khong can suffix /no_think
...
EXTRA_HEADERS = {
    ...
    "X-Title":      "PatchEval Wu Adapter (Claude Sonnet 5)",
}
PROMPT_SUFFIX = ""
